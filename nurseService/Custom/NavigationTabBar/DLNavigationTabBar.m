...
-(instancetype)initWithTitles:(NSArray *)titles
{
    if (self = [super initWithFrame:CGRectMake(0, 0, DL_ScreenWidth, 44)]) {
        self.buttonNormalTitleColor = [UIColor grayColor];
        self.buttonSelectedTileColor = APPDEFAULTORANGE;
...
{
    self.sliderView.backgroundColor = sliderBackgroundColor;
}
...
- (void)setButtonSelectedTileColor:(UIColor *)buttonSelectedTileColor
{
    _buttonSelectedTileColor = buttonSelectedTileColor;
}
