...
//    }
    ...
    [AFHttpTool requestWihtMethod:RequestMethodTypePost url:@"nurseAnduser/VerificationPasswordForNurseAndUser.action" params:params success:^(AFHTTPRequestOperation* operation,id response){
        [self hideHud];
