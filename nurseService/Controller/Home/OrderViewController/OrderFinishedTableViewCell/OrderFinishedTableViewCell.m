...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier cellSize:(CGSize)cellsize
{
    ...
    if (self) {
        ...
        orderIdNum = [[UILabel alloc] initWithFrame:CGRectMake(10, 45, 200, 20)];
        orderIdNum.textColor = [UIColor blackColor];
        orderIdNum.font = [UIFont systemFontOfSize:12.0];
        orderIdNum.text = @"订单编号：#1234567890";
        ...
        orderReceiveTime.text = @"接单时间：$1234567890";
        ...
        orderFinshTime.text = @"完成时间：1234567890";
